      ...
      <main className="flex flex-col items-center gap-5 px-1 py-10 bg-background text-off-white">
            <div className="flex flex-col items-center gap-2 relative w-1/1 md:w-3/5">
              <div className="text-center flex-1">
                ...
                <p className="md:text-2xl text-intermed-dark font-primary">
                  (EM ESCALA DE PONTOS, <a className='underline text-link' href="https://en.wikipedia.org/wiki/Cann_table" target="_blank">SAIBA MAIS</a>)
                </p>
              </div>
              <DownloadButton/>
            </div>
